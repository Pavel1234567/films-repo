...
class MainActivityModule(private val mainActivity: MainActivity) {
    ...
    @MainActivityScope
    @Provides
    fun provideMainPresenter(modelFilmsRepository: ModelFilmsRepository, filterFilms: FilterFilms): FilmsPresenter =
        FilmsPresenter(modelFilmsRepository, filterFilms)
